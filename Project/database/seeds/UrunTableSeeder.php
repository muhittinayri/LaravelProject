...
class UrunTableSeeder extends Seeder
{
    ...
    public function run(Faker\Generator $faker)
    {
        ...
        //Daha önceden urun tablosu oluşturulup veri eklendiği için urun detay tablosuda urun tablosuyla bağlantılı(foreıgn key) olduğu için bu kod yukarı ve buraya yazılmıştır.
