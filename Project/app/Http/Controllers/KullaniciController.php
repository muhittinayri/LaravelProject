...
class KullaniciController extends Controller
{
    ...
    public function giris()
    {
        ...
        $credentials = ['email'=>request('email'),'password'=>request('sifre'), 'aktif_mi'=> 1];
        if (auth()->attempt($credentials,request()->has('benihatirla')))
        {
            ...
            //dd($aktif_sepet_id); - bir alt satırı çalıştırma ekrana değer yazdırır

            session()->put('aktif_sepet_id',$aktif_sepet_id);

            //Session ile veritabanı birleştirmiş olduk
            if (Cart::count()>0){
            ...
            //Veritabanındaki tüm sepet ürünlerini yeniden sessiona yüklemiş olduk.
            Cart::destroy();
